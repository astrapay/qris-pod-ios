...
#ifndef ASTRAPAYQRISSDK_SWIFT_H
#define ASTRAPAYQRISSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AstraPayQrisSdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC15AstraPayQrisSdk7ApBadge")
@interface ApBadge : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)layoutSubviews;
@end

SWIFT_CLASS("_TtC15AstraPayQrisSdk11ApBottomBar")
@interface ApBottomBar : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (void)layoutSubviews;
@end

SWIFT_CLASS("_TtC15AstraPayQrisSdk10ApCheckbox")
@interface ApCheckbox : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)drawRect:(CGRect)rect;
@end

SWIFT_CLASS("_TtC15AstraPayQrisSdk15ApCheckboxGroup")
@interface ApCheckboxGroup : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
@end
...
@interface ApRadioButton (SWIFT_EXTENSION(AstraPayQrisSdk)) <UITableViewDataSource, UITableViewDelegate>
...
@class NSString;
SWIFT_CLASS("_TtC15AstraPayQrisSdk17ApRadioButtonCell")
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull AUTH_TOKEN;)
+ (NSString * _Nonnull)AUTH_TOKEN SWIFT_WARN_UNUSED_RESULT;
+ (void)setAUTH_TOKEN:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull SDK_TOKEN;)
+ (NSString * _Nonnull)SDK_TOKEN SWIFT_WARN_UNUSED_RESULT;
+ (void)setSDK_TOKEN:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) enum BuildMode BUILD_MODE;)
+ (enum BuildMode)BUILD_MODE SWIFT_WARN_UNUSED_RESULT;
+ (void)setBUILD_MODE:(enum BuildMode)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL qrisCpm;)
+ (BOOL)qrisCpm SWIFT_WARN_UNUSED_RESULT;
+ (void)setQrisCpm:(BOOL)value;
...
SWIFT_CLASS("_TtC15AstraPayQrisSdk11QRNewRouter")
@interface QRNewRouter : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) QRNewRouter * _Nonnull sharedInstance;)
+ (QRNewRouter * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, strong) id <QRProtocolSdk> _Nullable delegate;
- (void)navigateToQrScanFrom:(UIViewController * _Nonnull)vc;
- (void)presentQrScanFrom:(UIViewController * _Nonnull)vc;
- (void)popToQrScannerFrom:(UIViewController * _Nonnull)vc;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class QrisTransactionHistorySummary;
SWIFT_PROTOCOL("_TtP15AstraPayQrisSdk13QRProtocolSdk_")
@protocol QRProtocolSdk
- (void)onForbiddenWithViewController:(UIViewController * _Nonnull)viewController;
- (void)onCompleteWithViewController:(UIViewController * _Nonnull)viewController;
- (void)onFailedWithViewController:(UIViewController * _Nonnull)viewController;
- (void)onShowHistoryWithViewController:(UIViewController * _Nonnull)viewController;
...
SWIFT_CLASS_NAMED("QrisTransactionHistorySummary")
@interface QrisTransactionHistorySummary : NSObject
@property (nonatomic, copy) NSString * _Nullable transactionAt;
